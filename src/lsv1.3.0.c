/*
* Programming Assignment 03: lsv1.2.0
* Version 1.2.0 - Column Display Format
* Usage:
*       $ lsv1.2.0
*       $ lsv1.2.0 -l
*       $ lsv1.2.0 /home
*       $ lsv1.2.0 -l /home/kali/ /etc/
*
* Feature 3:
* - Default (no -l) now prints filenames in adaptive column format
* - Terminal width is detected using ioctl (fallback = 80 chars)
* - Layout: “down then across” style like real ls
*/
...
/* ===============================================
   Default Listing (Now Column Display)
   =============================================== */
void do_ls(const char *dir)
{
    struct dirent *entry;
...
/* ===============================================
   Helper Function: Column Display Logic
   =============================================== */
void print_in_columns(char **filenames, int count)
{
    struct winsize w;
