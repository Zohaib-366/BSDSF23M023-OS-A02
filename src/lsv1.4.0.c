/*
* Programming Assignment 04: lsv1.4.0
...
*       $ lsv1.4.0 -x
*       $ lsv1.4.0 /home
*       $ lsv1.4.0 -l /home/kali/ /etc/
*       $ lsv1.4.0 -x /home/kali/
*
* Feature 5:
* - Adds alphabetical sorting of directory contents using qsort()
* - Works for default, -l, and -x display modes
* - Sorting is applied before any display formatting
*/
