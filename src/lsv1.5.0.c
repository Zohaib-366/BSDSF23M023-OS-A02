/*
* Programming Assignment 04: lsv1.5.0
...
*       $ lsv1.5.0 -x
*       $ lsv1.5.0 /home
*       $ lsv1.5.0 -l /home/kali/ /etc/
*       $ lsv1.5.0 -x /home/kali/
*
* Feature 6:
* - Adds colorized output using ANSI escape codes
* - Colors filenames based on file type using stat()
* - Works for default, -l, and -x display modes
*/
...
int compare_filenames(const void *a, const void *b)
{
    ...
    return strcasecmp(fileA, fileB);   // case-insensitive comparison
}
...
void do_ls_long(const char *dir)
{
    ...
    while ((entry = readdir(dp)) != NULL) {
        ...
        // Print long listing format with colorized filename
